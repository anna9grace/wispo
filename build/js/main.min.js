...
Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_2__["initAccordion"])();
...
var initAccordion = function initAccordion() {
  ...
  var btns = accordion.querySelectorAll('.feature__title');
  ...
  var accordionToggleHandler = function accordionToggleHandler(evt) {
    var accordionItem = evt.target.closest('.feature');
    accordionItem.classList.toggle('feature--closed');
  };

  var setAccordionActive = function setAccordionActive() {
    btns.forEach(function (btn) {
      var accordionItem = btn.closest('.feature');
