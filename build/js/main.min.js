...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var o=n(/*! ./utils/ie-fix */"./js/utils/ie-fix.js"),r=n(/*! ./utils/ios-vh-fix */"./js/utils/ios-vh-fix.js"),i=n(/*! ./modules/init-accordion */"./js/modules/init-accordion.js");Object(o.ieFix)(),Object(r.iosVhFix)(),Object(i.initAccordion)()},"./js/modules/init-accordion.js":
/*!**************************************!*\
  !*** ./js/modules/init-accordion.js ***!
  \**************************************/
/*! exports provided: initAccordion */function(e,t,n){"use strict";n.r(t),n.d(t,"initAccordion",(function(){return o}));var o=function(){var e=document.querySelector(".js-accordion"),t=e.querySelectorAll(".feature__title"),n=window.matchMedia("(max-width: 767px)");if(e&&!(t.length<1)){var o=function(e){e.target.closest(".feature").classList.toggle("feature--closed")},r=function(){t.forEach((function(e){var t=e.closest(".feature");t&&(e.addEventListener("click",o),t.classList.add("feature--closed"))}))},i=function(){n.matches?r():t.forEach((function(e){var t=e.closest(".feature");t&&e.removeEventListener("click",o),t.classList.contains("feature--closed")&&t.classList.remove("feature--closed")}))};n.matches&&r(),n.addEventListener?n.addEventListener("change",i):n.addListener(i)}}},"./js/utils/ie-fix.js":
/*!****************************!*\
  !*** ./js/utils/ie-fix.js ***!
  \****************************/
